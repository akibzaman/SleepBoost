...
RESULTS.update({'recall',pre})
RESULTS.update({'recall',rec})
RESULTS.update({'recall',f1})
RESULTS.update({'recall',kappa})

accuracy = sum(RESULTS['accuracy'])/len(RESULTS['accuracy'])
precision = sum(RESULTS['precision'])/len(RESULTS['precision'])
recall = sum(RESULTS['recall'])/len(RESULTS['recall'])
f1Score = sum(RESULTS['f1_score'])/len(RESULTS['f1_score'])
kohenKappa = sum(RESULTS['kappa'])/len(RESULTS['kappa'])
